...
const s19 = flaggedItems.find(item => item.sentenceId === 19);
console.log("=== PROMPT HEADER ===");
console.log(selectivePrompt);
console.log("=== SENTENCE 19 DATA IN PROMPT ===");
console.log(JSON.stringify(s19, null, 2));
